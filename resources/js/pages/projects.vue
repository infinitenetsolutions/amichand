    ...
    <div>
        ...
        <section class="projects-section">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <h3 class="text-uppercase mb-3 mpl-5" > <span class="border-bottom border-warning" >Our</span> <span class="text-warning">Company</span></h3>
                        ...
                        <ul v-for="item in category" :key="item.id">
                            <li>
                                <h5 class="text-uppercase p-2">
                                    <router-link class="text-white" :to="{name:'products',params:{category:item.name.toLowerCase()}}">{{item.name}}
                                    </router-link>
                                </h5>
