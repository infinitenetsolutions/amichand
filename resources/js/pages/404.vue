...
<body>
    ...
    <!-- Header Section End -->
        ...
        <!-- faq Section Start -->
        <section class="error-area parallax-bg" data-background="images/bg/px-1.jpg" data-type="parallax" data-speed="3">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="error-page text-center">
                            ...
                            <div class="home-page">
                                <a href="index-2.html" class="btn-theme">Go to Home Page</a>
                            </div>
                        </div>
                    </div>
                </div>
